...
(2, 2, 4.7, true, ST_GeomFromText('POINT(77.6737 27.4924)', 4326)), -- Shri Krishna Janmasthan Temple
(3, 3, 4.5, true, ST_GeomFromText('POINT(77.6784 27.5035)', 4326)), -- Dwarkadhish Temple
(4, 4, 4.8, true, ST_GeomFromText('POINT(77.6710 27.4950)', 4326)), -- Vishram Ghat
(5, 5, 4.2, true, ST_GeomFromText('POINT(77.6843 27.5121)', 4326)), -- Kans Qila
(6, 6, 4.9, true, ST_GeomFromText('POINT(77.6817 27.5116)', 4326)), -- Mathura Museum
(7, 7, 4.6, true, ST_GeomFromText('POINT(77.6882 27.4954)', 4326)), -- Radha Kund
(8, 8, 4.3, true, ST_GeomFromText('POINT(77.6965 27.4972)', 4326)), -- Govardhan Hill
(9, 9, 4.4, true, ST_GeomFromText('POINT(77.6952 27.4957)', 4326)), -- Kusum Sarovar
(10, 10, 4.7, true, ST_GeomFromText('POINT(77.6794 27.5015)', 4326)), -- ISKCON Vrindavan
(11, 11, 4.1, true, ST_GeomFromText('POINT(77.6821 27.4959)', 4326)), -- Prem Mandir
